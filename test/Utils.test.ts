...
describe("Utils", () => {
  ...
  describe("#isValidPlatform", () => {
    ...
    it("should return true for curated platforms", () => {
      const curatedPlatform = [BungieMembershipType.TigerBlizzard, BungieMembershipType.TigerPsn, BungieMembershipType.TigerXbox]
      curatedPlatform.forEach(platform => {
        expect(isPlatformSupported(platform), `${platform} is not recognized`).to.be
          .true;
      });
    });
